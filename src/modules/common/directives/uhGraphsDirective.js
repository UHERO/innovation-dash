  ...
  function uhGraphsDirective() { //uh-map 
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        d3Charts(attrs.mapUrl, attrs.d3DataUrl, "#uh-map", "#uh-graph", "#uh-key", "#uh-histogram", '#uh-brush', attrs.colorScheme, attrs.d3YUnitMeasure, attrs.legendText, attrs.measurementUnit);
