  ...
  function uhGraphsDirective() { //uh-map 
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        d3Charts(scope, attrs.mapUrl, attrs.d3DataUrl, "#uh-current-year", "#uh-percent", "#uh-summary-measurement", "#uh-map", "#uh-graph", "#uh-key", "#uh-histogram", '#uh-brush', attrs.colorScheme, attrs.d3YUnitMeasure, attrs.legendText, attrs.measurementUnit);
      }
    };
  };
