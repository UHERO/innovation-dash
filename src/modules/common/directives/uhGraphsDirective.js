  ...
  function uhGraphsDirective() { //uh-map
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        d3Charts(scope, attrs.mapUrl, attrs.d3DataUrl, ".d3-graph", ".uh-current-year", ".uh-previous-year", ".uh-percent", ".uh-summary-measurement", ".uh-value-change", ".uh-price-parity", ".uh-annual-kauffman", "#uh-map", "#uh-graph", "#uh-key", "#uh-histogram", "#uh-brush", attrs.colorScheme, attrs.d3YUnitMeasure, attrs.legendText, attrs.measurementUnit);
